...
import { snkrsProductsQuery } from '@/sanity/lib/queries';
...
export default function SnkrsProducts() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      const products: Product[] = await client.fetch(snkrsProductsQuery);
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <span className="text-sm sm:text-base font-semibold"> Stylish Snkrs</span>
            </div>
